...
/*
    ...
    : 메서드
        ...
        - andThen(Function after) : 현재 결과를 다른 Function 입력에 연결
...
public class E_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println(stringLength.apply("asdf"));
        ...
        System.out.println(lengthAndSquare.apply("이 문자열 길이의 제곱 값은"));
