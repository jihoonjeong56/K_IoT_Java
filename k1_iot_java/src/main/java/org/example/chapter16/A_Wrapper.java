...
/*
    ...
    cf)기본 데이터 타입
    byte, short, int, long, char, float, double, boolean( + void 메서드)
    ...
    1) 박싱
        : 기본 타입을 Wrapper 클래스의 객체로 변환
    2) 언박싱
        : Wrapper 클래스의 객체 >> 기본타입으로 변환

    +) 장단점
    - 장점: 기본타입과 객체 타입간의 호환이 용이
...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        // : 두 Integer  객체를 비교해서 같으면 0, 호출객체(a)가 더크면 양수(1), 더 작으면 음수(-1)
