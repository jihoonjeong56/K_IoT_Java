...
class Car {
    ...
    // - 클래스의 속성(필드)를 사용하여 특정 작업을 수행 || 해당 값을 변경 또는 반환가능
    ...
    void displayInfo() { // lowerCamelCase(변수명과 동일)
        ...
        //  >> 반환(return)이 존재하지않을 경우 메서드명 앞에 반드시 작성
...
public class C_Object {
    public static void main(String[] args) {
        ...
        //클래스 타입 변수명 = new 생성자호출(필요한 테이터....);

        Car myCar = new Car("volvo xc60",2025);
        System.out.println(myCar);

        //객체 사용
        //.마침표연산자사용 - 객체 내부의 필드와 메서드를 사용
        //1. 필드 접근
        // : 객체면.필드명
        //  >A.B: A안에 B
        ...
        //2. 메서드 호줄
        // : 객체명.메서드면();
        //cf) A.B(): A안에 B를 실행해주세요
        myCar.displayInfo();

        //cf) 객체 생성 구문
        // '클래스명' 객체명 = new 클래서면(생성ㅈ아 매개변수값 전달);
