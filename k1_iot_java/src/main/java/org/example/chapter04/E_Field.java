...
//  >>프로그램이 시잘될 때 생성~ 프로그램이 종료될 때 소멸
//  cf) JVM의 'Method Area' 영역에 저장

//2. 지역변수
// : 특정 기능(메서드)이(가) 실행되는 동안에만 존재하는 '일시적인 변수'
...
//class CarClass{}
// >>접근제한자의 생략 - 기본값 default설정(같은 패키지 안에서 사용가능)
//class Car{
//
//}
...
class CarClass {
    ...
    //cf) 메서드명 - 동일한 스코프 내애서 같은 변수명 사용o(가능)
