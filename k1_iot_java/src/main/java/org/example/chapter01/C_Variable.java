...
public class C_Variable {
    public static void main(String[] args) {
        //===변수 (Variable)===//
        /*데이터를 저장하는 공간 (데이터를 메모리에 저장하고 사용할 때의 공간)
        1. 변수 선언 : 메모리 공간 생성
         >> 데이터타입 변수명;
         */
        ...
        2. 변수 초기화(할당) : 공간에 데이터 넣기
         >> 변수명  = 데이터값;*/
        num = 10;
        chr = '가';//문자(char)는 '', 문자열은(String) ""
        bool = true;


        //cf)초기화 - 처음 데이터를 넣는 과정
        // 할당 - 데이터를 바꾸는 과정
        //A=B; -> 우항 B에서 좌한  A로 갚을 '대입'한다.
        //같다 -> (==) =을 두개
        //3. 변수 선언과 동시에 초기화 (데이터타입 변수명 = 데이터값);
        int number = 10;
        char character = '나';
        ...
        int 0age;
        int 10age;*/
        //3) 기호는 _(언더스코어), $(달러)만 사용가능, 기호로 시작가능
        int _age;
        int $100age;
        //int age%;
...
//        int strawberryChocoCake;
        ...
        final int REGIDENT_NUMBER = 1234567;
//        REGIDENT_NUMBER = 999999; - 상수는 재할당 불가!

        //===변수(상수)명을 활용한 데이터값 호출===
        int numberValue = 10;
        //변수명 호출 시 변수(공간안의 데이터값이 출력)
