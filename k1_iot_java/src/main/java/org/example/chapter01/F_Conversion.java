...
public class F_Conversion {
    ...
    public static void main(String[] args) {
        ...
        char c1 = 'a'; //문자그대로
        char c2 = 97;//숫자로 넣기(97은 a의 유니코드값)
        char c3 = '\u0061';// 유니코드 값을 16진수로 표현한 문자.
        //같은 문자 a를 다양한 방식으로 출력
        ...
        int numberChar = 66;
        char letter66 = (char)numberChar; //명시적 형태의 형변환
