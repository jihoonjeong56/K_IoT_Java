...
public class StudentManagement {
    public static void main(String[] args) {
        ...
        dummyStudent.add(new Student(1, "a",25,"123"));
        dummyStudent.add(new Student(2, "b",22,"456"));
        dummyStudent.add(new Student(3, "c",21,"789"));
        dummyStudent.add(new Student(4, "d",28,"135"));
