...
class MyMath {
    ...
    void noReturn() {
        ...
        //return;
        //자바 컴파일러가 반환타입의 void를 읽는 경우, 해당 메서드의 마지막에 return;을 자동 추가
    }

    //조건문 반환 형식
    int max(int a, int b) {
        //정수 a, b를 비교하여 둘주 더 큰값 반환
        //if (a > b) return a;
        //else return b;
        int result;
        if (a > b) result = a;
...
public class C_Method {
    public static void main(String[] args) {
        ...
        System.out.println(mymath.max(12,13));
        System.out.println(mymath.min(12,13));
    }
}
