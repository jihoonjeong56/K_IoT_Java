...
//1) 메서드의 구조: 선언부, 구현부
//      반환타입 메서드명() {}
//      - 선언부: 변환타입 메서드명(매개변수 나열)
//      - 구현부: { 메서드 호출 시 수행될 코드 }

//cf) 변수'선언',[ 메서드'정의' - 선언부와 구현부를 작성한다.]
//+) 매개변수(parameter) 선언
// : 메서드가 작업을 수행하는데 필요한 값을 제공받음
// >> 필요한 개수만큼 선언, 데이터타입 생략 불가! 사용시 데이터 생략 불가!

//+) 구현부
//: 반환 타입이 void가 아닐 경우 반드시 'return 반환타입데이터0'
// >> 반환 값은 명시된 타입과 일치하거나 자동 형 변환 가능
...
public class B_Method {
    public static void main(String[] args) {
        ...
        //example.add("1","2"); 참조문자는 자동 형변환 안됨
        example.add('1','2'); //char(2), int (4) 자동형변환 가능
        example.add(10,20);
