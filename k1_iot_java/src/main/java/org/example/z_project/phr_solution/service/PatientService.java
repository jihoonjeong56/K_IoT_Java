...
public interface PatientService {
    //CR(전체 단건)UD
    void registerPatient(PatientCreateRequestDto dto); //C
    List<PatientListResponseDto> listAllPatients(); //R(전체)
    PatientDetailResponseDto getPatientById(Long id); //R(단건)
    void updatePatient(Long id, PatientUpdateRequestDto dto); //U
    void deletePatient(Long id);// D
