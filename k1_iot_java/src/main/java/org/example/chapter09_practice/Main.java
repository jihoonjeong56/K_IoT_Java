...
/*
    ...
    1) 요구사항
    User 클래스
    - 필드: id(사용자 고유번호), name, email, createdAt, updatedAt
    - 생성자: createdAt 값을 설정(+ 정보 수정 시 updatedAt 설정
    - 메서드: toString() 메서드 오버라이딩 사용자 정보 출력
    ...
    DateUtil '유틸' 클래스
     ...
     : UserServiceImpl을 인스턴스화 하여 동작을 실행
...
// cf) service
// : 일을 처리한는 곳
// EX) 학생 등록하가, 학생 정보 가져오기, 학생 삭제하기 등을 처리
//      model을 가지고 일을 하는 곳
...
public class Main {
    public static void main(String[] args) {
        ...
        //사용자 추가
        userService.addUser(new User(1, "a", "qwe@sdf.com"));
        userService.addUser(new User(2, "b", "q1560@YUI.com"));
        userService.addUser(new User(4, "b", "q12410@YUI.com"));
        userService.addUser(new User(3, "c", "dksl@dfsg.com"));
        ...
        //이메일 수정
        try {
            userService.updateUserEmail(1,"123145@asddf.com");
