...
// cf) Arrays 클래스
//      : 배열을 조작하는데 유용한 기능들을 제공해주는 '자바내부클래스'
//      >> java.util 내에 존재
//      >> 정렬, 검색, 변환 등.
public class D_Array {
    public static void main(String[] args) {
        //== Arrays 클래스 사용법 ==
        // : 자바의Array(배열) 자료형에만 동작
        //      >> 일반 배열만 사용
        //cf) 동적배열(ArrayList, List)는 사용불가 - Collections 클래스를 사용

        int[] numbers = {3, 5, 1, 4, 2};
        //1. 배열 절렬(오름차순): Arrays.sort( 절렬할 배열)
        Arrays.sort(numbers);
        ...
        // - 배열 내에 존재하면 존재하는 요소의 인덱스 번호를 반환
        // - 배열 내에 존재하지 않으면 해당 검색값의 음수를 반화(음수반환)
