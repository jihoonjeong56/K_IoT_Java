...
public class F_Practice {
    public static void main(String[] args) {
        ...
        while(isRun){ //무한루프
            ...
            switch (selectedMenu){
                case "1":
                    System.out.println("회원등록 가능입니다.");
                    break;
                case "2":
                    System.out.println("회원조회 가능입니다.");
                    boolean isRun2 = true;
                    while(isRun2){
                        ...
                        switch (selectedMenu){
                            case "1":
                                System.out.println("번호로 회원 조회합니다.");
                                break;
                            case "2":
                                System.out.println("이름으로 회원 조회합니다.");
                                break;
                            case "b":
